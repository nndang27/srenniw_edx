...
export default function ParentDashboard() {
  ...
  return (
    <div>
      <section id="section-calendar" className="scroll-mt-14 min-h-screen bg-gradient-to-b from-blue-50/30 to-white/60">
        <CalendarPage />
      </section>
      
      <section id="section-progress" className="scroll-mt-14 min-h-screen bg-gradient-to-b from-violet-50/40 to-white/60">
      ...
      <section id="section-transcript" className="scroll-mt-14 min-h-screen bg-gradient-to-b from-indigo-50/40 to-white/60">
        <div className="px-6 pt-10 pb-2">
      ...
      <section id="section-insights" className="scroll-mt-14 min-h-screen bg-gradient-to-b from-emerald-50/40 to-white/60">
        <div className="px-6 pt-10 pb-2">
