...
from agent.core.middleware.summarization import (
    SummarizationMiddleware,
    SummarizationToolMiddleware,
)
from agent.core.backends import FilesystemBackend
...
from agent.core.middleware._utils import append_to_system_message
...
if TYPE_CHECKING:
    ...
    from agent.core.backends.protocol import BACKEND_TYPES, BackendProtocol
        ...
        **deprecated_kwargs: Any,
        ...
        Args:
            ...
            truncate_args_settings: Settings for truncating large tool arguments in old messages.
                ...
                Provide a [`TruncateArgsSettings`][agent.core.middleware.summarization.TruncateArgsSettings]
        ...
        Example:
            ```python
            from agent.core.middleware.summarization import SummarizationMiddleware
            from agent.core.backends import StateBackend
...
def create_summarization_tool_middleware(
    ...
    Example:
        ...
        ```
    """
    from agent.core._models import resolve_model  # noqa: PLC0415
...
class SummarizationToolMiddleware(AgentMiddleware):
    ...
    an explicit user action, e.g. as implemented in the agent.core-cli).
