...
from agent.core.backends.protocol import (
...
from agent.core.backends.utils import (
    _get_file_type,
    check_empty_content,
...
class FilesystemMiddleware(AgentMiddleware[FilesystemState, ContextT, ResponseT]):
    ...
    Example:
        ...
        from agent.core.backends import StateBackend, StoreBackend, CompositeBackend
