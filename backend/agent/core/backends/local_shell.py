...
from agent.core.backends.protocol import ExecuteResponse, SandboxBackendProtocol
...
class LocalShellBackend(FilesystemBackend, SandboxBackendProtocol):
    ...
    Examples:
        ```python
        from agent.core.backends import LocalShellBackend
    ...
    def __init__(
        ...
        *,
        ...
        if virtual_mode is None:
            warnings.warn(
                "LocalShellBackend virtual_mode default will change in agent.core 0.5.0; "
                ...
                "See https://reference.langchain.com/python/agent.core/ for usage guidelines.",
                DeprecationWarning,
                stacklevel=2,
            )
            virtual_mode = False
