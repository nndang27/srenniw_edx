...
from agent.core.backends.protocol import BackendFactory, BackendProtocol
...
from agent.core.middleware.patch_tool_calls import PatchToolCallsMiddleware
from agent.core.middleware.skills import SkillsMiddleware
from agent.core.middleware.subagents import (
    GENERAL_PURPOSE_SUBAGENT,
    CompiledSubAgent,
    SubAgent,
    SubAgentMiddleware,
)
from agent.core.middleware.summarization import create_summarization_middleware
    ...
    *,
    ...
    return create_agent(
    ...
    ).with_config(
        {
            ...
            "metadata": {
                "ls_integration": "agent.core",
                "versions": {"agent.core": __version__},
                "lc_agent_name": name,
            },
        }
    )
